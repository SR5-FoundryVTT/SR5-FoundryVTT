...
var SR5Actor = /*#__PURE__*/function (_Actor) {
  ...
  var _super2 = _createSuper(SR5Actor);
  ...
  (0, _createClass2["default"])(SR5Actor, [{
    key: "update",
    value: function update(data, options) {
      ...
      var _super = Object.create(null, {
        update: {
          get: function get() {
            return (0, _get2["default"])((0, _getPrototypeOf2["default"])(SR5Actor.prototype), "update", _this);
          }
        }
      });
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.next = 7;
                return this.updateEmbeddedEntity('OwnedItem', itemUpdates);
    ...
    value: function setOverwatchScore(value) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", this.setFlag('shadowrun5e', 'overwatchScore', num));
    ...
    value: function prepareData() {
      ...
      for (var _i2 = 0, _Object$keys = Object.keys(CONFIG.SR5.elementTypes); _i2 < _Object$keys.length; _i2++) {
      ...
      for (var _i3 = 0, _Object$values = Object.values(items); _i3 < _Object$values.length; _i3++) {
        var _item = _Object$values[_i3];
        var itemData = _item.data;
        var type = _item.type;
        var equipped = (_a = itemData.technology) === null || _a === void 0 ? void 0 : _a.equipped;

        if (equipped) {
          if (itemData.armor && itemData.armor.value) {
            if (itemData.armor.mod) armor.mod += itemData.armor.value; // if it's a mod, add to the mod field
            else armor.value = itemData.armor.value; // if not a mod, set armor.value to the items value

            for (var _i4 = 0, _Object$keys2 = Object.keys(CONFIG.SR5.elementTypes); _i4 < _Object$keys2.length; _i4++) {
              var _element = _Object$keys2[_i4];
              armor[_element] = itemData.armor[_element];
            }
          }
        } // MODIFIES ESSENCE
        ...
        if (_item.type === 'device' && ((_b = itemData.technology) === null || _b === void 0 ? void 0 : _b.equipped)) {
          matrix.device = _item._id;
          ...
          matrix.name = _item.name;
          matrix.item = itemData;

          if (itemData.category === 'cyberdeck' && itemData.atts) {
            for (var _i5 = 0, _Object$entries = Object.entries(itemData.atts); _i5 < _Object$entries.length; _i5++) {
              var _Object$entries$_i = (0, _slicedToArray2["default"])(_Object$entries[_i5], 2),
      ...
      for (var _i6 = 0, _Object$entries2 = Object.entries(attrs); _i6 < _Object$entries2.length; _i6++) {
        ...
        if (!_att.hidden) {
          if (!_att.mod) _att.mod = {};
          _att.value = _att.base + _helpers.Helpers.totalMods(_att.mod);
        }
      }
      ...
      for (var _i7 = 0, _Object$values2 = Object.values(active); _i7 < _Object$values2.length; _i7++) {
        var skill = _Object$values2[_i7];

        if (!skill.hidden) {
          if (!skill.mod) skill.mod = {};
          skill.value = skill.base + _helpers.Helpers.totalMods(skill.mod);
        }
      }

      {
        ...
        entries.forEach(function (_ref) {
          ...
          return val._delete && delete data.skills.language.value[key];
        });
      }

      for (var _i8 = 0, _Object$values3 = Object.values(language.value); _i8 < _Object$values3.length; _i8++) {
        var _skill = _Object$values3[_i8];
        if (!_skill.mod) _skill.mod = {};
      ...
      for (var _i9 = 0, _Object$entries3 = Object.entries(knowledgeSkills); _i9 < _Object$entries3.length; _i9++) {
        ...
        group.value = _entries.filter(function (_ref3) {
      ...
      if (matrix.condition_monitor.value > matrix.condition_monitor.max) matrix.condition_monitor.value = matrix.condition_monitor.max; // ADD MATRIX ATTS TO LIMITS
      ...
      for (var _i10 = 0, _Object$entries4 = Object.entries(limits); _i10 < _Object$entries4.length; _i10++) {
        var _Object$entries4$_i = (0, _slicedToArray2["default"])(_Object$entries4[_i10], 2),
            l = _Object$entries4$_i[0],
            limit = _Object$entries4$_i[1];

        limit.label = CONFIG.SR5.limits[l];
      } // skill labels


      for (var _i11 = 0, _Object$entries5 = Object.entries(active); _i11 < _Object$entries5.length; _i11++) {
        var _Object$entries5$_i = (0, _slicedToArray2["default"])(_Object$entries5[_i11], 2),
            s = _Object$entries5$_i[0],
            _skill2 = _Object$entries5$_i[1];
      ...
      for (var _i12 = 0, _Object$entries6 = Object.entries(attrs); _i12 < _Object$entries6.length; _i12++) {
        ...
        _att2.label = CONFIG.SR5.attributes[a];
      } // tracks


      for (var _i13 = 0, _Object$entries7 = Object.entries(track); _i13 < _Object$entries7.length; _i13++) {
        var _Object$entries7$_i = (0, _slicedToArray2["default"])(_Object$entries7[_i13], 2),
            t = _Object$entries7$_i[0],
            tr = _Object$entries7$_i[1];
    ...
    value: function addKnowledgeSkill(category, skill) {
      ...
      var value = {};
      value[id] = skill;
      var fieldName = "data.skills.knowledge.".concat(category, ".value");
      var updateData = {};
    ...
    value: function removeKnowledgeSkill(skillId, category) {
      var value = {};
      var updateData = {};
      var dataString = "data.skills.knowledge.".concat(category, ".value");
      value[skillId] = {
        _delete: true
      };
    ...
    value: function rollFade() {
      ...
      var incoming = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : -1;
    ...
    value: function rollDrain() {
      ...
      var incoming = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : -1;
      var wil = this.data.data.attributes.willpower;
      var drainAtt = this.data.data.attributes[this.data.data.magic.attribute];
      var parts = {};
      parts[wil.label] = wil.value;
    ...
    value: function rollDefense() {
      ...
      var template = 'systems/shadowrun5e/templates/rolls/roll-defense.html';
      var special = '';
      var cancel = true;
        ...
        renderTemplate(template, dialogData).then(function (dlg) {
          new Dialog({
            ...
            buttons: {
              ...
              full_defense: {
                label: "".concat(game.i18n.localize('SR5.FullDefense'), " (+").concat(_this2.data.data.attributes.willpower.value, ")"),
                callback: function callback() {
            ...
            close: function close(html) {
              return __awaiter(_this2, void 0, void 0, /*#__PURE__*/_regenerator["default"].mark(function _callee4() {
                ...
                var rea, _int, parts, fireMode, cover;
                ...
                return _regenerator["default"].wrap(function _callee4$(_context4) {
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      ...
                      case 2:
                        rea = this.data.data.attributes.reaction;
                        _int = this.data.data.attributes.intuition;
                        parts = {};
                        parts[rea.label] = rea.value;
                        parts[_int.label] = _int.value;
                        if (this.data.data.modifiers.defense) parts['SR5.Bonus'] = this.data.data.modifiers.defense;
                        fireMode = _helpers.Helpers.parseInputToNumber($(html).find('[name=fireMode]').val());
                        cover = _helpers.Helpers.parseInputToNumber($(html).find('[name=cover]').val());
                        ...
                        resolve(_dice.DiceSR.rollTest({
                          event: options.event,
                          actor: this,
                          parts: parts,
                          title: 'Defense'
                        }).then(function (roll) {
                          return __awaiter(_this3, void 0, void 0, /*#__PURE__*/_regenerator["default"].mark(function _callee3() {
                            var defenderHits, attack, attackerHits, netHits, damage, damageType, ap;
                                ...
                                switch (_context3.prev = _context3.next) {
                                  case 0:
                                    ...
                                    if (options.incomingAttack && roll) {
                                      defenderHits = roll.total;
                                      attack = options.incomingAttack;
                                      attackerHits = attack.hits || 0;
                                      netHits = attackerHits - defenderHits;

                                      if (netHits >= 0) {
                                        damage = options.incomingAttack.damage + netHits;
                                        damageType = options.incomingAttack.damageType;
                                        ap = options.incomingAttack.ap; // ui.notifications.info(`Got Hit: DV${damage}${damageType ? damageType.charAt(0).toUpperCase() : ''} ${ap}AP`);
    ...
    key: "rollSoak",
    value: function rollSoak(options) {
      var _this4 = this;
      ...
      var id = '';
      var cancel = true;
      var template = 'systems/shadowrun5e/templates/rolls/roll-soak.html';
      return new Promise(function (resolve) {
        renderTemplate(template, dialogData).then(function (dlg) {
          new Dialog({
            title: 'Soak Test',
            ...
            close: function close(html) {
              return __awaiter(_this4, void 0, void 0, /*#__PURE__*/_regenerator["default"].mark(function _callee5() {
                var body, armor, parts, armorId, bonusArmor, ap, armorVal, label, title;
                return _regenerator["default"].wrap(function _callee5$(_context5) {
                  while (1) {
                    switch (_context5.prev = _context5.next) {
                      ...
                      case 3:
                        body = this.data.data.attributes.body;
                        ...
                        armorId = id === 'default' ? '' : id;
                        bonusArmor = armor[armorId] || 0;
                        if (bonusArmor) parts[_helpers.Helpers.label(armorId)] = bonusArmor;
                        ap = _helpers.Helpers.parseInputToNumber($(html).find('[name=ap]').val());

                        if (ap) {
                          armorVal = armor.value + bonusArmor; // don't take more AP than armor

                          parts['SR5.AP'] = Math.max(ap, -armorVal);
                        }

                        label = _helpers.Helpers.label(id);
                        title = "Soak - ".concat(label);
                        if (options === null || options === void 0 ? void 0 : options.damage) title += " - Incoming Damage: ".concat(options.damage);
                        resolve(_dice.DiceSR.rollTest({
    ...
    value: function rollSingleAttribute(attId, options) {
      ...
      return _dice.DiceSR.rollTest({
        ...
        actor: this,
        parts: parts,
        title: _helpers.Helpers.label(attId)
      });
    }
  }, {
    key: "rollTwoAttributes",
    value: function rollTwoAttributes(_ref7, options) {
    ...
    value: function rollNaturalRecovery(track, options) {
      var _this5 = this;
      ...
      return _dice.DiceSR.rollTest({
        ...
        title: title,
        extended: true,
        after: function after(roll) {
          return __awaiter(_this5, void 0, void 0, /*#__PURE__*/_regenerator["default"].mark(function _callee6() {
            ...
            return _regenerator["default"].wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 2:
                    hits = roll.total;
                    current = this.data.data.track[track].value;
                    current = Math.max(current - hits, 0);
                    key = "data.track.".concat(track, ".value");
                    u = {};
                    u[key] = current;
                    _context6.next = 10;
    ...
    value: function rollMatrixAttribute(attr, options) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regenerator["default"].mark(function _callee8() {
        var _this6 = this;

        var matrix_att, title, parts, attributes, attribute, dialogData, buttons, cancel;
        return _regenerator["default"].wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                matrix_att = this.data.data.matrix[attr];
                title = game.i18n.localize(CONFIG.SR5.matrixAttributes[attr]);
                parts = {};
                ...
                if (!_helpers.Helpers.hasModifiers(options === null || options === void 0 ? void 0 : options.event)) {
                  _context8.next = 7;
                  break;
                }

                return _context8.abrupt("return", _dice.DiceSR.rollTest({
                  event: options === null || options === void 0 ? void 0 : options.event,
                  actor: this,
                  parts: parts,
                  title: title
              ...
              case 7:
                attributes = _helpers.Helpers.filter(this.data.data.attributes, function (_ref9) {
                ...
                cancel = true;
                renderTemplate('systems/shadowrun5e/templates/rolls/matrix-roll.html', dialogData).then(function (dlg) {
                  new Dialog({
                    title: "".concat(title, " Test"),
                    content: dlg,
                    buttons: buttons,
                    close: function close(html) {
                      return __awaiter(_this6, void 0, void 0, /*#__PURE__*/_regenerator["default"].mark(function _callee7() {
                        var newAtt, att;
                          ...
                          while (1) {
                            switch (_context7.prev = _context7.next) {
                              ...
                              case 2:
                                ...
                                return _context7.abrupt("return", _dice.DiceSR.rollTest({
                                  event: options === null || options === void 0 ? void 0 : options.event,
                                  actor: this,
                                  parts: parts,
                                  title: title
    ...
    key: "promptRoll",
    value: function promptRoll(options) {
      return _dice.DiceSR.rollTest({
        event: options === null || options === void 0 ? void 0 : options.event,
        actor: this,
        dialogOptions: {
    ...
    value: function rollAttributesTest(rollId, options) {
      var title = game.i18n.localize(CONFIG.SR5.attributeRolls[rollId]);
    ...
    key: "rollSkill",
    value: function rollSkill(skill, options) {
      var _this7 = this;
      ...
      if ((options === null || options === void 0 ? void 0 : options.event) && _helpers.Helpers.hasModifiers(options === null || options === void 0 ? void 0 : options.event)) {
      ...
      var dialogData = {
        ...
        attributes: _helpers.Helpers.filter(this.data.data.attributes, function (_ref11) {
      ...
      renderTemplate('systems/shadowrun5e/templates/rolls/skill-roll.html', dialogData).then(function (dlg) {
        new Dialog({
          title: "".concat(title, " Test"),
          content: dlg,
          buttons: buttons,
          close: function close(html) {
            return __awaiter(_this7, void 0, void 0, /*#__PURE__*/_regenerator["default"].mark(function _callee9() {
              var newAtt, newLimit;
                ...
                while (1) {
                  switch (_context9.prev = _context9.next) {
                    ...
                    case 2:
                      ...
                      return _context9.abrupt("return", _dice.DiceSR.rollTest({
                        event: options === null || options === void 0 ? void 0 : options.event,
                        actor: this,
                        parts: parts,
                        limit: limit ? limit.value : undefined,
    ...
    value: function rollKnowledgeSkill(catId, skillId, options) {
    ...
    value: function rollLanguageSkill(skillId, options) {
      var skill = duplicate(this.data.data.skills.language.value[skillId]);
    ...
    key: "rollActiveSkill",
    value: function rollActiveSkill(skillId, options) {
    ...
    key: "rollAttribute",
    value: function rollAttribute(attId, options) {
      var _this8 = this;
      ...
      var cancel = true;
      renderTemplate('systems/shadowrun5e/templates/rolls/single-attribute.html', dialogData).then(function (dlg) {
        new Dialog({
          ...
          "default": 'roll',
          close: function close(html) {
            return __awaiter(_this8, void 0, void 0, /*#__PURE__*/_regenerator["default"].mark(function _callee10() {
              ...
              return _regenerator["default"].wrap(function _callee10$(_context10) {
                while (1) {
                  switch (_context10.prev = _context10.next) {
                    ...
                    case 2:
                      limit = undefined;
                      att2Id = _helpers.Helpers.parseInputToString($(html).find('[name=attribute2]').val());
                      att2 = undefined;
                      ...
                      if (att2Id !== 'none') {
                        ...
                        if (att2 === null || att2 === void 0 ? void 0 : att2.label) {
                          parts[att2.label] = att2.value;
                          att2IdLabel = game.i18n.localize(CONFIG.SR5.attributes[att2Id]);
                          title += " + ".concat(att2IdLabel);
                        }
                      }
                      ...
                      return _context10.abrupt("return", _dice.DiceSR.rollTest({
                        event: options === null || options === void 0 ? void 0 : options.event,
                        title: "".concat(title, " Test"),
                        actor: this,
                        parts: parts,
    ...
    key: "pushTheLimit",
    value: function pushTheLimit(roll) {
            ...
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                return _context11.abrupt("return", _dice.DiceSR.rollTest({
                  ...
                  title: "".concat(title, " - Push the Limit"),
                  actor: actor,
                  wounds: false
                }));
    ...
    key: "secondChance",
    value: function secondChance(roll) {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regenerator["default"].mark(function _callee12() {
        var formula, hits, title, re, matches, match, pool, msg, actor, parts;
        return _regenerator["default"].wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                formula = roll.find('.dice-formula').text();
                hits = parseInt(roll.find('.dice-total').text());
                title = roll.find('.flavor-text').text();
                re = /(\d+)d6/;
                ...
                match = matches[1];
                pool = parseInt(match.replace('d6', ''));
                ...
                return _context12.abrupt("return", _dice.DiceSR.rollTest({
                  event: {
                    shiftKey: true
                  },
                  title: "".concat(title, " - Second Chance"),
                  parts: parts,
                  wounds: false,
                  actor: actor
                }).then(function () {
...
},{"../dice.js":14,"../helpers.js":16,"@babel/runtime/helpers/classCallCheck":29,"@babel/runtime/helpers/createClass":30,"@babel/runtime/helpers/get":32,"@babel/runtime/helpers/getPrototypeOf":33,"@babel/runtime/helpers/inherits":34,"@babel/runtime/helpers/interopRequireDefault":35,"@babel/runtime/helpers/possibleConstructorReturn":40,"@babel/runtime/helpers/slicedToArray":42,"@babel/runtime/regenerator":47}],2:[function(require,module,exports){
"use strict";
...
class SR5Actor extends Actor {
    ...
    prepareData() {
        ...
        for (let [, att] of Object.entries(attributes)) {
            if (!att.hidden) {
                if (!att.mod)
                    att.mod = {};
                att.value = att.base + helpers_js_1.Helpers.totalMods(att.mod);
            }
        }
        if (language) {
            if (!language.value)
        ...
        for (const skill of Object.values(active)) {
            if (!skill.hidden) {
                if (!skill.mod)
                    skill.mod = {};
                skill.value = skill.base + helpers_js_1.Helpers.totalMods(skill.mod);
            }
        }
        {
            ...
            renderTemplate(template, dialogData).then((dlg) => {
                new Dialog({
                    ...
                    close: (html) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        let fireMode = helpers_js_1.Helpers.parseInputToNumber($(html).find('[name=fireMode]').val());
                        let cover = helpers_js_1.Helpers.parseInputToNumber($(html).find('[name=cover]').val());
                        ...
                        resolve(dice_js_1.DiceSR.rollTest({
                            event: options.event,
                            actor: this,
                            parts,
                            title: 'Defense',
            ...
            renderTemplate(template, dialogData).then((dlg) => {
                new Dialog({
                    ...
                    close: (html) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (bonusArmor)
                            parts[helpers_js_1.Helpers.label(armorId)] = bonusArmor;
                        const ap = helpers_js_1.Helpers.parseInputToNumber($(html).find('[name=ap]').val());
                        if (ap) {
                            let armorVal = armor.value + bonusArmor;
                            // don't take more AP than armor
                            parts['SR5.AP'] = Math.max(ap, -armorVal);
                        }
                        const label = helpers_js_1.Helpers.label(id);
    ...
    rollSingleAttribute(attId, options) {
        ...
        return dice_js_1.DiceSR.rollTest({
            ...
            actor: this,
            parts,
            title: helpers_js_1.Helpers.label(attId),
        });
    }
    rollTwoAttributes([id1, id2], options) {
        const attr1 = this.data.data.attributes[id1];
        const attr2 = this.data.data.attributes[id2];
        const label1 = helpers_js_1.Helpers.label(id1);
        const label2 = helpers_js_1.Helpers.label(id2);
        const parts = {};
        parts[attr1.label] = attr1.value;
        parts[attr2.label] = attr2.value;
        this._addMatrixParts(parts, [attr1, attr2]);
    ...
    rollMatrixAttribute(attr, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (helpers_js_1.Helpers.hasModifiers(options === null || options === void 0 ? void 0 : options.event)) {
                return dice_js_1.DiceSR.rollTest({
                    event: options === null || options === void 0 ? void 0 : options.event,
                    actor: this,
                    parts,
            ...
            const attributes = helpers_js_1.Helpers.filter(this.data.data.attributes, ([, value]) => value.value > 0);
            ...
            renderTemplate('systems/shadowrun5e/templates/rolls/matrix-roll.html', dialogData).then((dlg) => {
                new Dialog({
                    ...
                    close: (html) => __awaiter(this, void 0, void 0, function* () {
                        if (cancel)
                            return;
                        const newAtt = helpers_js_1.Helpers.parseInputToString($(html).find('[name=attribute]').val());
                        let att = undefined;
                        if (newAtt) {
                            att = this.data.data.attributes[newAtt];
    ...
    rollSkill(skill, options) {
        ...
        const parts = {};
        parts[skill.label] = skill.value;
        if ((options === null || options === void 0 ? void 0 : options.event) && helpers_js_1.Helpers.hasModifiers(options === null || options === void 0 ? void 0 : options.event)) {
            parts[att.label] = att.value;
        ...
        let dialogData = {
            attribute: skill.attribute,
            attributes: helpers_js_1.Helpers.filter(this.data.data.attributes, ([, value]) => value.value > 0),
            limit: att.limit,
            limits: this.data.data.limits,
        };
        let cancel = true;
            ...
            new Dialog({
                ...
                close: (html) => __awaiter(this, void 0, void 0, function* () {
                    if (cancel)
                        return;
                    const newAtt = helpers_js_1.Helpers.parseInputToString($(html).find('[name="attribute"]').val());
                    const newLimit = helpers_js_1.Helpers.parseInputToNumber($(html).find('[name="attribute.limit"]').val());
                    att = this.data.data.attributes[newAtt];
                    title += ` + ${game.i18n.localize(CONFIG.SR5.attributes[newAtt])}`;
                    limit = this.data.data.limits[newLimit];
                    parts[att.label] = att.value;
            ...
            new Dialog({
                ...
                close: (html) => __awaiter(this, void 0, void 0, function* () {
                    if (cancel)
                        return;
                    let limit = undefined;
                    const att2Id = helpers_js_1.Helpers.parseInputToString($(html).find('[name=attribute2]').val());
                    let att2 = undefined;
                    if (att2Id !== 'none') {
                        att2 = atts[att2Id];
                        if (att2 === null || att2 === void 0 ? void 0 : att2.label) {
    ...
    _addMatrixParts(parts, atts) {
        if (helpers_js_1.Helpers.isMatrix(atts)) {
  ...
  (0, _createClass2["default"])(ChummerImportForm, [{
    ...
    value: function activateListeners(html) {
      ...
      html.find('.submit-chummer-import').click( /*#__PURE__*/function () {
        var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(event) {
          var chummerfile, weapons, armor, cyberware, equipment, qualities, powers, spells, parseAtt, parseDamage, getValues, getArray, updateData, update, items, error, c, attr, atts, skills, i, s, group, skill, id, category, skillCategory, cat, name, _qualities, _weapons, armors, cyberwares, _powers, gears, licenses, _spells;
                        ...
                        try {
                          ...
                          if (w.type.toLowerCase() === 'melee') {
                            ...
                            if (w.accessories && w.accessories.accessory) {
                              range.mods = [];
                              var accessories = getArray(w.accessories.accessory);
...
},{"@babel/runtime/helpers/asyncToGenerator":28,"@babel/runtime/helpers/classCallCheck":29,"@babel/runtime/helpers/createClass":30,"@babel/runtime/helpers/get":32,"@babel/runtime/helpers/getPrototypeOf":33,"@babel/runtime/helpers/inherits":34,"@babel/runtime/helpers/interopRequireDefault":35,"@babel/runtime/helpers/possibleConstructorReturn":40,"@babel/runtime/regenerator":47}],5:[function(require,module,exports){
"use strict";
...
},{"./language-skill-edit.js":7,"@babel/runtime/helpers/classCallCheck":29,"@babel/runtime/helpers/createClass":30,"@babel/runtime/helpers/getPrototypeOf":33,"@babel/runtime/helpers/inherits":34,"@babel/runtime/helpers/interopRequireDefault":35,"@babel/runtime/helpers/possibleConstructorReturn":40}],7:[function(require,module,exports){
"use strict";
...
var LanguageSkillEditForm = /*#__PURE__*/function (_SkillEditForm) {
  ...
  (0, _createClass2["default"])(LanguageSkillEditForm, [{
    ...
    key: "getData",
    value: function getData() {
      return mergeObject((0, _get2["default"])((0, _getPrototypeOf2["default"])(LanguageSkillEditForm.prototype), "getData", this).call(this), {
        editable_name: true
      });
    }
    /** @override */
...
var SkillEditForm = /*#__PURE__*/function (_BaseEntitySheet) {
  ...
  (0, _createClass2["default"])(SkillEditForm, [{
    key: "_updateString",
    value: function _updateString() {
    ...
    value: function _onUpdateObject(event, formData, updateData) {
      ...
      var specs = Object.entries(formData).reduce(function (running, _ref) {
        var _ref2 = (0, _slicedToArray2["default"])(_ref, 2),
            key = _ref2[0],
            val = _ref2[1];
    ...
    key: "activateListeners",
    value: function activateListeners(html) {
      (0, _get2["default"])((0, _getPrototypeOf2["default"])(SkillEditForm.prototype), "activateListeners", this).call(this, html);
    ...
    key: "defaultOptions",
    get: function get() {
      var options = (0, _get2["default"])((0, _getPrototypeOf2["default"])(SkillEditForm), "defaultOptions", this);
...
const entity_js_1 = require("./actor/entity.js");
...
},{"./actor/entity.js":1}],11:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
var DiceSR = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(DiceSR, null, [{
    ...
    value: function rollTest(_ref2) {
      ...
      var template = 'systems/shadowrun5e/templates/rolls/roll-dialog.html';
      var edge = false;
      var cancel = true;
      return new Promise(function (resolve) {
        renderTemplate(template, dialogData).then(function (dlg) {
          new Dialog({
            ...
            buttons: {
              ...
              edge: {
                label: "Push the Limit (+".concat(edgeAttMax, ")"),
            ...
            close: function close(html) {
              ...
              var dicePool = _helpers.Helpers.parseInputToNumber($(html).find('[name="dice_pool"]').val());

              +_helpers.Helpers.parseInputToNumber($(html).find('[name="dp_mod"]').val());
              +_helpers.Helpers.parseInputToNumber($(html).find('[name="wounds"]').val());
              -_helpers.Helpers.parseInputToNumber($(html).find('[name="options.environmental"]').val());

              var limit = _helpers.Helpers.parseInputToNumber($(html).find('[name="limit"]').val());

              var extended = _helpers.Helpers.parseInputToNumber($(html).find('[name="extended"]').val()) !== 0;
              ...
              if (extended && r) {
                var currentExtended = parts['SR5.Extended'] || 0;
              ...
              resolve(r);
              if (after && r) r.then(function (roll) {
                return after(roll);
              });
            }
          }).render(true);
...
},{"./config.js":12,"./helpers":17,"@babel/runtime/helpers/classCallCheck":29,"@babel/runtime/helpers/createClass":30,"@babel/runtime/helpers/interopRequireDefault":35,"@babel/runtime/regenerator":47}],15:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
            ...
            renderTemplate(template, dialogData).then((dlg) => {
                new Dialog({
                    ...
                    close: (html) => {
                        ...
                        const extended = helpers_1.Helpers.parseInputToNumber($(html).find('[name="extended"]').val()) !== 0;
                        if (edge && actor) {
                            dicePool += actor.data.data.attributes.edge.max;
                            actor.update({
                                'data.attributes.edge.value': actor.data.data.attributes.edge.value - 1,
...
},{"./config.js":12,"./helpers":17}],16:[function(require,module,exports){
"use strict";
...
var Helpers = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Helpers, null, [{
    ...
    value: function isMatrix(atts) {
      ...
      var matrixAtts = ['firewall', 'data_processing', 'sleaze', 'attack'];
      ...
      atts.forEach(function (att) {
        if (typeof att === 'string' && matrixAtts.includes(att)) return true;else if (matrixLabels.includes(att.label)) return true;
      });
      return false;
    }
  }, {
    key: "parseInputToString",
    value: function parseInputToString(val) {
    ...
    key: "parseInputToNumber",
    value: function parseInputToNumber(val) {
    ...
    value: function addLabels(obj, label) {
      if ((0, _typeof2["default"])(obj) === 'object' && obj !== null) {
        ...
        Object.entries(obj).filter(function (_ref3) {
          var _ref4 = (0, _slicedToArray2["default"])(_ref3, 2),
              value = _ref4[1];
...
},{"@babel/runtime/helpers/classCallCheck":29,"@babel/runtime/helpers/createClass":30,"@babel/runtime/helpers/interopRequireDefault":35,"@babel/runtime/helpers/slicedToArray":42,"@babel/runtime/helpers/typeof":45}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Helpers = void 0;
class Helpers {
...
class SR5Item extends Item {
    ...
    prepareData() {
        ...
        if (technology === null || technology === void 0 ? void 0 : technology.conceal) {
            ...
            technology.conceal.value =
                technology.conceal.base + helpers_js_1.Helpers.totalMods(technology.conceal.mod);
        }
        if (action) {
            action.alt_mod = 0;
            action.limit.mod = {};
            ...
            action.damage.value = action.damage.base + helpers_js_1.Helpers.totalMods(action.damage.mod);
            action.damage.ap.value =
                action.damage.ap.base + helpers_js_1.Helpers.totalMods(action.damage.ap.mod);
            action.limit.value = action.limit.base + helpers_js_1.Helpers.totalMods(action.limit.mod);
            if (this.actor) {
        ...
        if (range) {
            if (range.rc) {
                ...
                if (range.rc)
                    range.rc.value = range.rc.base + helpers_js_1.Helpers.totalMods(range.rc.mod);
            }
        }
    ...
    _actionChatData(data, labels, props) {
        if (data.action) {
            ...
            if (data.action.skill) {
                labels.roll = `${helpers_js_1.Helpers.label(data.action.skill)}+${helpers_js_1.Helpers.label(data.action.attribute)}`;
            }
            else if (data.action.attribute2) {
                labels.roll = `${helpers_js_1.Helpers.label(data.action.attribute)}+${helpers_js_1.Helpers.label(data.action.attribute2)}`;
            }
            if (data.action.damage.type.value) {
                const { damage } = data.action;
                if (damage.value)
                    props.push(`DV ${damage.value}${damage.type.value ? damage.type.value.toUpperCase().charAt(0) : ''}`);
            ...
            if (data.action.opposed.type) {
                ...
                if (opposed.type !== 'custom')
                    labels.opposedRoll = `vs. ${helpers_js_1.Helpers.label(opposed.type)}`;
                else if (opposed.skill)
                    labels.opposedRoll = `vs. ${helpers_js_1.Helpers.label(opposed.skill)}+${helpers_js_1.Helpers.label(opposed.attribute)}`;
                else if (opposed.attribute2)
                    labels.opposedRoll = `vs. ${helpers_js_1.Helpers.label(opposed.attribute)}+${helpers_js_1.Helpers.label(opposed.attribute2)}`;
                else if (opposed.attribute)
                    labels.opposedRoll = `vs. ${helpers_js_1.Helpers.label(opposed.attribute)}`;
    ...
    _complex_formChatData(data, labels, props) {
        this._actionChatData(data, labels, props);
        props.push(helpers_js_1.Helpers.label(data.target), helpers_js_1.Helpers.label(data.duration));
        const { fade } = data;
        if (fade > 0)
    ...
    _spellChatData(data, labels, props) {
        this._actionChatData(data, labels, props);
        props.push(helpers_js_1.Helpers.label(data.range), helpers_js_1.Helpers.label(data.duration), helpers_js_1.Helpers.label(data.type), helpers_js_1.Helpers.label(data.category));
        const { drain } = data;
        if (drain > 0)
    ...
    _weaponChatData(data, labels, props) {
        ...
        if (data.category === 'range') {
            if (data.range.rc)
                props.push(`RC ${data.range.rc.value}`);
            if (data.range.modes)
                props.push(Array.from(Object.entries(data.range.modes))
    ...
    rollOpposedTest(target, ev) {
        ...
        if (this.getFlag('shadowrun5e', 'attack')) {
            ...
            if (options.incomingAttack.fireMode)
                options.fireModeDefense = helpers_js_1.Helpers.mapRoundsToDefenseMod(options.incomingAttack.fireMode);
            options.cover = true;
        }
    ...
    rollTest(ev) {
        const itemData = this.data.data;
        if (!this.actor)
            return console.error('COULD NOT FIND ACTOR');
            ...
            return renderTemplate('systems/shadowrun5e/templates/rolls/range-weapon-roll.html', dialogData).then((dlg) => {
                ...
                new Dialog({
                    ...
                    close: (html) => {
                        if (cancel)
                            return;
                        const fireMode = helpers_js_1.Helpers.parseInputToNumber($(html).find('[name="fireMode"]').val());
                        if (fireMode) {
                            title += ` - Defender (${helpers_js_1.Helpers.mapRoundsToDefenseDesc(fireMode)})`;
                        }
            ...
            renderTemplate('systems/shadowrun5e/templates/rolls/roll-spell.html', dialogData).then((dlg) => {
                new Dialog({
                    ...
                    close: (html) => {
                        if (cancel)
                            return;
                        const force = helpers_js_1.Helpers.parseInputToNumber($(html).find('[name=force]').val());
                        limit = force;
                        dice_js_1.DiceSR.rollTest({
                            event: ev,
                            dialogOptions: {
                            ...
                            (_a = this.actor) === null || _a === void 0 ? void 0 : _a.rollDrain({ event: ev }, drain);
                        }));
                    },
                }).render(true);
            });
            ...
            renderTemplate('systems/shadowrun5e/templates/rolls/roll-complex-form.html', dialogData).then((dlg) => {
                new Dialog({
                    ...
                    close: (html) => {
                        if (cancel)
                            return;
                        const level = helpers_js_1.Helpers.parseInputToNumber($(html).find('[name=level]').val());
                        limit = level;
                        dice_js_1.DiceSR.rollTest({
                            event: ev,
                            dialogOptions: {
...
},{"../dice.js":14,"../helpers.js":16}],19:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Hooks.once('init', function () {
    ...
    Actors.registerSheet('shadowrun5e', sheet_2.SR5ActorSheet, { makeDefault: true });
    Items.unregisterSheet('core', ItemSheet);
    Items.registerSheet('shadowrun5e', sheet_1.SR5ItemSheet, { makeDefault: true });
    ['renderSR5ActorSheet', 'renderSR5ItemSheet'].forEach((s) => {
        Hooks.on(s, (app, html, data) => helpers_1.Helpers.setupCustomCheckbox(app, html));
    });
...
Hooks.on('renderChatMessage', (app, html, data) => {
    if (!app.isRoll)
        entity_2.SR5Item.chatListeners(html);
    if (app.isRoll)
...
},{"./actor/entity":2,"./actor/sheet":3,"./apps/gmtools/OverwatchScoreTracker":5,"./canvas":9,"./chat":10,"./combat":11,"./config":13,"./dice":15,"./helpers":17,"./item/entity":18,"./item/sheet":19,"./migration":21,"./settings":22,"./templates":23}],21:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"./arrayLikeToArray":24}],27:[function(require,module,exports){
...
module.exports = _get;
},{"./superPropBase":43}],33:[function(require,module,exports){
...
},{"./setPrototypeOf":41}],35:[function(require,module,exports){
...
},{"../helpers/typeof":45,"./assertThisInitialized":27}],41:[function(require,module,exports){
...
},{"./arrayWithHoles":25,"./iterableToArrayLimit":37,"./nonIterableRest":38,"./unsupportedIterableToArray":46}],43:[function(require,module,exports){
...
},{"./getPrototypeOf":33}],44:[function(require,module,exports){
...
},{"./arrayWithoutHoles":26,"./iterableToArray":36,"./nonIterableSpread":39,"./unsupportedIterableToArray":46}],45:[function(require,module,exports){
...
},{"./arrayLikeToArray":24}],47:[function(require,module,exports){
