...
export const quenchRegister = (quench: Quench) => {
    ...
    quench.registerBatch('shadowrun5e.entities.actors', shadowrunSR5Actor, {
        displayName: 'SHADOWRUN5e: SR5Actor Test',
    });
    ...
    quench.registerBatch('shadowrun5e.flow.tests', shadowrunTestValueResolution, { displayName: 'SHADOWRUN5e: Test Value Resolution' });
