...
export const FLAGS = {
    ...
    TokenActiveVisionMode: 'TokenActiveVisionMode',
    TokenDetectionRangeOverrides: 'TokenDetectionRangeOverrides',
    ActorDefaultVisionMode: 'ActorDefaultVisionMode',
    ActorDetectionRangeOverrides: 'ActorDetectionRangeOverrides',
    PlaceablePlanes: 'planes',
    PlanePhysical: 'physical',
    PlaneAstral: 'astral',
    PlaneMatrix: 'matrix',
    ScenePlaneBrushState: 'ScenePlaneBrushState',
    WallType: 'wallType',
    WallMatrixBlocked: 'matrixBlocked',
    TemplateIsVisualSmoke: 'isVisualSmoke',
    TemplateIsThermalSmoke: 'isThermalSmoke',
