...
import {ModifiableValue, ModifiableValuePriority} from "../mods/ModifiableValue";
...
export class CombatRules {
    ...
    static modifyDamageAfterMiss(damage: DamageType, isHitWithNoDamage?: boolean): DamageType {
        ...
        ModifiableValue.add(
            modifiedDamage, 'SR5.TestResults.Success', 0, { type: 'override', priority: ModifiableValuePriority.TOP }
        );
        ModifiableValue.calcTotal(modifiedDamage, { min: 0 });
        ModifiableValue.add(
            modifiedDamage.ap, 'SR5.TestResults.Success', 0, { type: 'override', priority: ModifiableValuePriority.TOP }
        );
