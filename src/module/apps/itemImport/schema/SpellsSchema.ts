...
export interface SpellsSchema {
    ...
    categories: {
        category: Many<{ _TEXT: string; $: { alchemicalskill?: "Alchemy"; barehandedadeptskill?: "Unarmed Combat"; translate?: string; useskill: "Artificing" | "Ritual Spellcasting" | "Spellcasting"; }; }>;
    };
    spells: {
        spell: Many<Spell>;
    };
