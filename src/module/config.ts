...
export const SR5 = {
    ...
    itemSubTypeIconOverrides: {
        ...
        weapon: {
            ...
            'assault-cannons': '',
            'assault-rifles': '',
            'bio-weapon': 'systems/shadowrun5e/dist/icons/importer/bioware/bio-weapons.svg',
            'blades': '',
            'bows': '',
            'carbines': '',
            'clubs': '',
            'crossbows': '',
            'cyberweapon': 'systems/shadowrun5e/dist/icons/importer/cyberware/cyber-implannt-weapon.svg',
