...
export const SR5 = {
    ...
    itemSubTypes: {
        ...
        bioware:        ['basic', 'bio-weapons', 'biosculpting', 'chemical-gland-modifications', 'complimentary-genetics', 'cosmetic-bioware',
                        'cultured', 'environmental-microadaptation', 'exotic-metaglands', 'genetic-restoration', 'immunization', 'orthoskin-upgrades',
        ...
        equipment:      ['alchemical-tools', 'appearance-modification', 'armor-enhancements', 'audio-devices',
                        ...
                        'custom-cyberdeck-attributes', 'cyberdeck-modules', 'cyberterminals', 'disguises', 'drug-grades', 'drugs',
                        'electronic-accessories', 'electronic-modification', 'electronic-parts', 'electronics-accessories', 'entertainment',
                        'explosives', 'extraction-devices', 'foci', 'food', 'formulae', 'grapple-gun', 'hard-nanoware', 'housewares',
                        'id-credsticks', 'magical-compounds', 'magical-supplies', 'matrix-accessories', 'metatype-specific', 'miscellany',
                        'musical-instruments', 'nanogear', 'paydata', 'pi-tac', 'pi-tac-programs', 'printing', 'reporter-gear',
                        'rfid-tags', 'security-devices', 'sensor-functions', 'sensor-housings', 'sensors', 'services', 'skillsofts',
                        'software', 'software-tweaks', 'survival-gear', 'tailored-perfume-cologne', 'tools', 'tools-of-the-trade', 'toxins',
                        'vision-devices', 'vision-enhancements'],
        host:           [],
        lifestyle:      [],
